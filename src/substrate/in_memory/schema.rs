...
use crate::substrate::in_memory::substrate::InMemorySubstrate;
...
const ROLE_FIELDS: &[FieldMapping<ValueSlot>] = &[
    FieldMapping { key: "name", slot: ValueSlot::Value },
    FieldMapping { key: "description", slot: ValueSlot::Value },
    FieldMapping { key: "purpose", slot: ValueSlot::Value },
    FieldMapping { key: "traits", slot: ValueSlot::Value },
    FieldMapping { key: "extensions", slot: ValueSlot::Value },
];
const HOOK_FIELDS: &[FieldMapping<ValueSlot>] = &[
    FieldMapping { key: "name", slot: ValueSlot::Value },
    FieldMapping { key: "description", slot: ValueSlot::Value },
    FieldMapping { key: "instructions", slot: ValueSlot::Value },
    FieldMapping { key: "inputs", slot: ValueSlot::Value },
    FieldMapping { key: "extensions", slot: ValueSlot::Value },
];
const TEAM_FIELDS: &[FieldMapping<ValueSlot>] = &[
    FieldMapping { key: "name", slot: ValueSlot::Value },
    FieldMapping { key: "description", slot: ValueSlot::Value },
    FieldMapping { key: "members", slot: ValueSlot::Value },
    FieldMapping { key: "include", slot: ValueSlot::Value },
    FieldMapping { key: "import", slot: ValueSlot::Value },
    FieldMapping { key: "extensions", slot: ValueSlot::Value },
];
const ARTIFACT_KIND_FIELDS: &[FieldMapping<ValueSlot>] = &[
    FieldMapping { key: "name", slot: ValueSlot::Value },
    FieldMapping { key: "description", slot: ValueSlot::Value },
    FieldMapping { key: "service", slot: ValueSlot::Value },
    FieldMapping { key: "access", slot: ValueSlot::Value },
    FieldMapping { key: "guidance", slot: ValueSlot::Value },
    FieldMapping { key: "extensions", slot: ValueSlot::Value },
];
const WORKFLOW_FIELDS: &[FieldMapping<ValueSlot>] = &[
    ...
    FieldMapping { key: "description", slot: ValueSlot::Value },
    FieldMapping { key: "purpose", slot: ValueSlot::Value },
    FieldMapping { key: "raci", slot: ValueSlot::Value },
    FieldMapping { key: "states", slot: ValueSlot::Value },
    FieldMapping { key: "steps", slot: ValueSlot::Value },
    FieldMapping { key: "intercepts", slot: ValueSlot::Value },
    FieldMapping { key: "guidance", slot: ValueSlot::Value },
    FieldMapping { key: "extensions", slot: ValueSlot::Value },
];
const TASK_FIELDS: &[FieldMapping<ValueSlot>] = &[
    ...
    FieldMapping { key: "purpose", slot: ValueSlot::Value },
    FieldMapping { key: "instructions", slot: ValueSlot::Value },
    FieldMapping { key: "criteria", slot: ValueSlot::Value },
    FieldMapping { key: "raci", slot: ValueSlot::Value },
    FieldMapping { key: "artifact.kind", slot: ValueSlot::Value },
    FieldMapping { key: "artifact.template", slot: ValueSlot::Value },
    FieldMapping { key: "states", slot: ValueSlot::Value },
    FieldMapping { key: "intercepts", slot: ValueSlot::Value },
    FieldMapping { key: "guidance", slot: ValueSlot::Value },
    FieldMapping { key: "extensions", slot: ValueSlot::Value },
...
const RELAY_FIELDS: &[FieldMapping<ValueSlot>] = &[
    ...
    FieldMapping { key: "purpose", slot: ValueSlot::Value },
    FieldMapping { key: "raci", slot: ValueSlot::Value },
    FieldMapping { key: "delegates_to", slot: ValueSlot::Value },
    FieldMapping { key: "briefing", slot: ValueSlot::Value },
    FieldMapping { key: "debriefing", slot: ValueSlot::Value },
    FieldMapping { key: "state_map", slot: ValueSlot::Value },
    FieldMapping { key: "intercepts", slot: ValueSlot::Value },
    FieldMapping { key: "guidance", slot: ValueSlot::Value },
    FieldMapping { key: "extensions", slot: ValueSlot::Value },
];
...
impl SubstrateSchema<InMemorySubstrate> for Workflow {
    const SCHEMA: EntitySchema<ValueSlot> =
        simple_schema!("workflows/{id}", WORKFLOW_FIELDS);
}
...
impl SubstrateSchema<InMemorySubstrate> for EmbeddedWorkflow {
    const SCHEMA: EntitySchema<ValueSlot> =
        simple_schema!("{parent.base}/{id}", WORKFLOW_FIELDS);
}
...
impl SubstrateSchema<InMemorySubstrate> for Relay {
    const SCHEMA: EntitySchema<ValueSlot> =
        simple_schema!("{parent.base}/{id}", RELAY_FIELDS);
}
